...
主人公にあるステイタスはＨＰと空腹度だけ。ローグで最も恐ろしいのは餓死である。と	
...
無料開放された第１期アスキーネットで、rogueはオンライン ゲームとして公開されてい	
...
ラーの「ローグクローン２」をjunetで発表した。スピードと操作性がよくなり、 なんと	
いっても色がついてみやすい。これが現在もインターネット上で配布や 公開がされてい	
る、みんなのスタンダード版「ローグ」である。 ローグクローン２も、許可をもらって	
...
Windows機を購入。ローグは？？と心配したのだが、 ローグクローン２はPC98のMS-DOS用	
...
○おとなの自由研究
自由研究｜『ローグ・クローン２　日本語版１．３』は、どのバージョンの日本語版なのか？
